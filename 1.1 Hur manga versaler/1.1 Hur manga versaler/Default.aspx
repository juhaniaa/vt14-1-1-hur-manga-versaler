<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="_1._1_Hur_manga_versaler.Default" ViewStateMode="Disabled" %>
...
<body>
    ...
    <div>
        ...
        <asp:TextBox ID="TextBox" runat="server" TextMode="MultiLine" CssClass="textBox" ViewStateMode="Enabled"></asp:TextBox>
